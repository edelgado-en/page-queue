...
export default function Home() {
  ...
  return (
    ...
    <div class="fixed flex min-h-screen w-64 flex-col bg-red-600 z-50">sidebar</div> {/* w-64 when expanded. w-14 skinny */}
  
    <div class="w-full">
      <div class="mt-1 bg-orange-600" style={{ marginLeft: '250px' }}>{/* 60px when skinny */}
         {/* <div className="shadow sm:rounded-md m-3 mt-0 md:px-3 h-14
