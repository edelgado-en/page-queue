import { CalendarIcon, ChevronRightIcon,
     ArrowSmRightIcon, LockClosedIcon,
      PencilAltIcon, TrashIcon } from '@heroicons/react/solid'
...
export default function Example() {
    ...
    useLayoutEffect(() => {
        const isIndeterminate = selectedPeople.length > 0 && selectedPeople.length < positions.length
                    ...
                    <div className="px-2 py-2 flex flex-wrap hover:bg-gray-100">
                        <div className="lg:w-1/5 md:w-1/2 sm:w-1/2 md:mt-2 md:mb-2 sm:mt-2 sm:mb-2">
                            <div className="truncate">
                                ...
                                <input
                                    ...
                                    />
                                    <p className="ml-1 font-medium text-indigo-600 truncate">88280213</p>
                                    <p className="ml-1 flex-shrink-0 font-normal text-gray-500 text-xs">OSO - HTML</p>
                                </div>
                        ...
                        <div className="lg:w-1/5 md:w-1/3 sm:w-1/3 md:mt-2 md:mb-2 sm:mt-2 sm:mb-2">
                            <div className="flex flex-row flex-nowrap gap-1">
                                <div className="text-xs font-medium text-right">Created:</div>
                                <div className="text-xs text-right">04-29-2022 08:58 AM</div>
                            </div>
                            <div className="text-xs">TransSync</div>
                        </div>
                        <div className="lg:w-1/5 md:w-1/3 sm:w-1/3 md:mt-2 md:mb-2 sm:mt-2 sm:mb-2">
                            <div className="flex flex-row flex-nowrap gap-1">
                                <div className="text-xs font-medium text-right">Updated:</div>
                                <div className="text-xs text-right">04-29-2022 08:58 AM</div>
                            </div>
                        ...
                        <div className="lg:w-1/5 md:w-1/3 sm:w-1/3 md:mt-2 md:mb-2 sm:mt-2 sm:mb-2">
                            <div className="flex flex-row flex-nowrap gap-1">
                                <div className="text-xs font-medium text-right">Assigned:</div>
                                <div className="text-xs text-right">04-29-2022 08:58 AM</div>
                            </div>
                            <div className="text-xs">
                                PTS <ArrowSmRightIcon className="h-3 w-3 inline-block" /> <span>edelgado</span> <ArrowSmRightIcon className="h-3 w-3 inline-block" /> <span>adeberry</span>
                            </div>
